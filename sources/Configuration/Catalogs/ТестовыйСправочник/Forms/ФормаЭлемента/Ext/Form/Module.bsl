...
Процедура ОткрытьЧислоЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ТипЗнч(Результат) = Тип("Структура") Тогда
		ИзменитьРеквизитФормыСоСтруктурированнымЗначением(ДополнительныеПараметры.Элемент.Имя, Результат);
	КонецЕсли;
...
Процедура ИзменитьРеквизитФормыСоСтруктурированнымЗначением(Знач ИмяЭлемента, Знач Значение)
	...
	ЧастиПути = СтрРазделить(ЭтаФорма.Элементы[ИмяЭлемента].ПутьКДанным, ".");
