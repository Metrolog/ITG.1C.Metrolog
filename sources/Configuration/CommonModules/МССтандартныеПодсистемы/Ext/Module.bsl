...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Итог) Экспорт
	...
	// 2.3.3.33
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.3.3.33",
		"Роль._ДемоИспользованиеДосьеКонтрагента", "Роль._ДемоПросмотрОтчетаДосьеКонтрагента");
...
Процедура ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты) Экспорт
	...
	// СтандартныеПодсистемыИТГ
	СтандартныеПодсистемыИТГ.ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты);
	// Конец СтандартныеПодсистемыИТГ
	
	// МетрологическаяСлужба.ЕдиницыВеличин
	ЕдиницыВеличин.ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты);
	// Конец МетрологическаяСлужба.ЕдиницыВеличин
...
////////////////////////////////////////////////////////////////////////////////
// Обработчики событий подсистемы СтруктурированныеРеквизиты.

// См. комментарий к одноименной процедуре в общем модуле СтруктурированныеРеквизитыПереопределяемый.
Процедура ПриОпределенииОбъектовСоСтруктурированнымиРеквизитами(Объекты) Экспорт
	
	// _Демо начало примера
	Объекты.Вставить(Метаданные.Справочники.ТестовыйСправочник.ПолноеИмя(), "");
	// _Демо конец примера
...
Процедура ПриОпределенииОбъектовСРедактируемымиРеквизитами(Объекты) Экспорт
	...
	// СтандартныеПодсистемыИТГ
	СтандартныеПодсистемыИТГ.ПриОпределенииОбъектовСРедактируемымиРеквизитами(Объекты);
	// Конец СтандартныеПодсистемыИТГ
	
	// МетрологическаяСлужба.ЕдиницыВеличин
	ЕдиницыВеличин.ПриОпределенииОбъектовСРедактируемымиРеквизитами(Объекты);
	// Конец МетрологическаяСлужба.ЕдиницыВеличин
...
Процедура ПриЗаполненииРеквизитовПартнераВЗаявленииНаСертификат(Параметры) Экспорт
	...
	Если Реквизиты.ВидКонтрагента = Перечисления._ДемоВидКонтрагента.ФизическоеЛицо Тогда
...
Процедура ЗаполнитьПрофильРуководитель(Знач ОписанияПрофилей)
	...
	ОписаниеПрофиля.Роли.Добавить("_ДемоПросмотрОтчетаДосьеКонтрагента");
