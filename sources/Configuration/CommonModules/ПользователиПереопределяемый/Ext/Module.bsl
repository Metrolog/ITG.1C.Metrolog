...
Процедура ПриОпределенииНазначенияРолей(НазначениеРолей) Экспорт
	...
	МССтандартныеПодсистемы.ПриОпределенииНазначенияРолей(НазначениеРолей);
	// _Демо конец примера
...
Процедура ПриУстановкеНачальныхНастроек(НачальныеНастройки) Экспорт
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ПриУстановкеНачальныхНастроек(НачальныеНастройки);
	// _Демо конец примера
...
Процедура ПриПолученииПрочихНастроек(СведенияОПользователе, Настройки) Экспорт
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ПриПолученииПрочихНастроек(СведенияОПользователе, Настройки);
	// _Демо конец примера
...
Процедура ПриСохраненииПрочихНастроек(СведенияОПользователе, Настройки) Экспорт
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ПриСохраненииПрочихНастроек(СведенияОПользователе, Настройки);
	// _Демо конец примера
...
Процедура ПриУдаленииПрочихНастроек(СведенияОПользователе, Настройки) Экспорт
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ПриУдаленииПрочихНастроек(СведенияОПользователе, Настройки);
	// _Демо конец примера
