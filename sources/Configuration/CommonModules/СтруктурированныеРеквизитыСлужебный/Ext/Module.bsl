...
// ОбщийМодуль.СтруктурированныеРеквизитыСлужебный.
// 
////////////////////////////////////////////////////////////////////////////////

#Область СлужебныйПрограммныйИнтерфейс

// Проверяет, что в объекте метаданных используются структурированные реквизиты.
//
// Параметры:
//  ПолноеИмя - Строка - полное имя объекта метаданных.
//
Функция СтруктурированныеРеквизитыИспользуются(Знач ПолноеИмя) Экспорт
	
	Объекты = Новый Соответствие;
	СтруктурированныеРеквизитыПереопределяемый.ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты);
...
Процедура ЗаполнитьСвязанныеЭлементы(МассивСвязанныхЭлементов, Знач Форма, Знач ИмяРеквизита)
