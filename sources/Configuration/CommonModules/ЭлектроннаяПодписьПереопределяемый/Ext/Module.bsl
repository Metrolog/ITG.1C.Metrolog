...
Процедура ПриЗаполненииРеквизитовОрганизацииВЗаявленииНаСертификат(Параметры) Экспорт
	...
	МССтандартныеПодсистемы.ПриЗаполненииРеквизитовОрганизацииВЗаявленииНаСертификат(Параметры);
	// _Демо конец примера
...
Процедура ПриЗаполненииРеквизитовВладельцаВЗаявленииНаСертификат(Параметры) Экспорт
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ПриЗаполненииРеквизитовВладельцаВЗаявленииНаСертификат(Параметры);
	// _Демо конец примера
...
Процедура ПриЗаполненииРеквизитовРуководителяВЗаявленииНаСертификат(Параметры) Экспорт
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ПриЗаполненииРеквизитовРуководителяВЗаявленииНаСертификат(Параметры);
	// _Демо конец примера
...
Процедура ПриЗаполненииРеквизитовПартнераВЗаявленииНаСертификат(Параметры) Экспорт
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ПриЗаполненииРеквизитовПартнераВЗаявленииНаСертификат(Параметры);
	// _Демо конец примера
...
Процедура ПриСозданииФормыПроверкаСертификата(Сертификат, ДополнительныеПроверки, ПараметрыДополнительныхПроверок, СтандартныеПроверки) Экспорт
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ПриСозданииФормыПроверкаСертификата(Сертификат,
...
Процедура ПриДополнительнойПроверкеСертификата(Сертификат, Проверка, МенеджерКриптографии, ОписаниеОшибки, ЭтоПредупреждение) Экспорт
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ПриДополнительнойПроверкеСертификата(Сертификат,
		Проверка, МенеджерКриптографии, ОписаниеОшибки, ЭтоПредупреждение);
	// _Демо конец примера
