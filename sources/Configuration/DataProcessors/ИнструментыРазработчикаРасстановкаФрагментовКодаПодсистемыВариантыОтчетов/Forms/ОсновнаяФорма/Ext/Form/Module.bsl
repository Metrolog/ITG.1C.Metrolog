		...
		Если Не ПустаяСтрока(НастроитьВариантыОтчета_БывшееТело) Тогда
			НастроитьВариантыОтчета_БывшееТело = 
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = '%1: Удалить устаревшее содержимое процедуры ""до расстановки фрагментов кода"":%2(не удалено чтобы при необходимости было легче восстановить стиль оформления):%3'"),
					СимволыПСТаб + "// " + Пояснение(),
					СимволыПСТаб + "//       ",
