...
Функция ПолучитьВычисляемыеРеквизиты()
	...
	НовыеЗначения.Вставить("Обозначение", РаботаСЕдиницамиВеличинСервер.СформироватьОбозначениеЕдиницыВеличины(Объект));
	НовыеЗначения.Вставить("Наименование", РаботаСЕдиницамиВеличинСервер.СформироватьНаименованиеЕдиницыВеличины(Объект));	
