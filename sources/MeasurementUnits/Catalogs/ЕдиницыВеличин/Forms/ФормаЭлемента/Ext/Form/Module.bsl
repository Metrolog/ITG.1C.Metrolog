...
Процедура МаксимальныйПоказательСтепениПриставкиНачалоВыбораНаСервере(ДанныеВыбора, СтандартнаяОбработка,
...
Процедура МаксимальныйПоказательСтепениПриставкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	МаксимальныйПоказательСтепениПриставкиНачалоВыбораНаСервере(
		ДанныеВыбора, СтандартнаяОбработка,
