...
Процедура ПоказательСтепениПриставкиНачалоВыбораНаСервере(ДанныеВыбора, СтандартнаяОбработка,
	Знач ОснованиеСтепениПриставки,
	Знач МинимальныйПоказательСтепениПриставки = -99, Знач МаксимальныйПоказательСтепениПриставки = 99)

	Справочники.ПриставкиЕдиницыВеличин.ОбработкаПолученияДанныхВыбораДляДиапазонаПоказателей(
		ДанныеВыбора, СтандартнаяОбработка,
		ОснованиеСтепениПриставки,
		МинимальныйПоказательСтепениПриставки, МаксимальныйПоказательСтепениПриставки);
...
Процедура МинимальныйПоказательСтепениПриставкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПоказательСтепениПриставкиНачалоВыбораНаСервере(
		ДанныеВыбора, СтандартнаяОбработка,
		Объект.ОснованиеСтепениПриставки, , Объект.МаксимальныйПоказательСтепениПриставки);
...
Процедура МаксимальныйПоказательСтепениПриставкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПоказательСтепениПриставкиНачалоВыбораНаСервере(
		ДанныеВыбора, СтандартнаяОбработка,
		Объект.ОснованиеСтепениПриставки, Объект.МинимальныйПоказательСтепениПриставки);
