...
Функция ПолучитьБлокируемыеРеквизитыОбъекта() Экспорт
	...
	Для Каждого ВариантОбозначения Из Метаданные.Перечисления.МСЕдиницыВеличинОбозначения.ЗначенияПеречисления Цикл
		...
		БлокируемыеРеквизиты.Добавить("ПробелПередОбозначением" + ВариантОбозначения.Имя);
		БлокируемыеРеквизиты.Добавить("ПредлогДляЗнаменателя" + ВариантОбозначения.Имя);
	КонецЦикла;
...
Процедура ОбработкаПолученияПолейПредставления(Поля, СтандартнаяОбработка) 
	...
	Для Каждого ВариантОбозначения Из Метаданные.Перечисления.МСЕдиницыВеличинОбозначения.ЗначенияПеречисления Цикл
		...
		Поля.Добавить("Обозначение" + ВариантОбозначения.Имя);
	КонецЦикла;
