...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ИмеетСпециальныеНаименованиеИОбозначение Тогда
		...
		Для Каждого ВариантОбозначения Из Перечисления.МСЕдиницыВеличинОбозначения Цикл
			
			Если МСЕдиницыВеличинКлиентСерверПовтИсп.ИспользуютсяОбозначения(ВариантОбозначения) Тогда
				
				ЭтотОбъект[МСЕдиницыВеличинКлиентСерверПовтИсп.ПолучитьРеквизитОбозначения(ВариантОбозначения)] = 
					МСЕдиницыВеличинСервер.СформироватьОбозначениеЕдиницыВеличины(ЭтотОбъект, ВариантОбозначения);
				ЭтотОбъект[МСЕдиницыВеличинКлиентСерверПовтИсп.ПолучитьРеквизитНаименования(ВариантОбозначения)] =
					МСЕдиницыВеличинСервер.СформироватьНаименованиеЕдиницыВеличины(ЭтотОбъект, ВариантОбозначения);
