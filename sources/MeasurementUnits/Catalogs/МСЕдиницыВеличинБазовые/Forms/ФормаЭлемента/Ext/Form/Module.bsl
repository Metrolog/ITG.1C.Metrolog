...
Функция ПолучитьВычисляемыеРеквизиты()
	...
	Для Каждого ВариантОбозначения Из Метаданные.Перечисления.МСЕдиницыВеличинОбозначения.ЗначенияПеречисления Цикл
		Если ПолучитьФункциональнуюОпцию("МСЕдиницыВеличинИспользоватьОбозначения" + ВариантОбозначения.Имя) Тогда
			НовыеЗначения.Вставить("Обозначение" + ВариантОбозначения.Имя, МСЕдиницыВеличинСервер.СформироватьОбозначениеЕдиницыВеличины(Объект));
			НовыеЗначения.Вставить("Наименование" + ВариантОбозначения.Имя, МСЕдиницыВеличинСервер.СформироватьНаименованиеЕдиницыВеличины(Объект));
		КонецЕсли;
	КонецЦикла;
