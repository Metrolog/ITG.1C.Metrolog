...
Функция ПолучитьБлокируемыеРеквизитыОбъекта() Экспорт
	...
	Для Каждого Реквизит Из Метаданные.Справочники.МСЕдиницыВеличинПриставкиКратныхИДольных.Реквизиты Цикл
		БлокируемыеРеквизиты.Добавить(Реквизит.Имя);
	КонецЦикла;
...
Процедура ОбработкаПолученияПолейПредставления(Поля, СтандартнаяОбработка) 
    ...
    Поля.Добавить("Приставка");
    Поля.Добавить("ПриставкаМеждународная");
    Поля.Добавить("ПриставкаISO_80000_1");
    Поля.Добавить("ПриставкаМеждународнаяISO_80000_1");
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка) 
	...
	Если Данные.Порядок = 0 Тогда
		Представление = "";
	Иначе
	    Представление = Данные[ПолучитьРеквизитПриставки()] + " (" + Данные.Основание + РаботаСоСтрокамиЮникодКлиентСервер.ПолучитьСтрокуИзПоказателяСтепени(Данные.Порядок) + ")";
	КонецЕсли;
...
// Возвращает наименование реквизита, содержащего приставку в зависимости от функциональных опций.
//
// Возвращаемое значение:
//   Строка - наименование реквизита
//
Функция ПолучитьРеквизитПриставки() Экспорт
	
	Перем Обозначения;
	Обозначения = ПолучитьФункциональнуюОпцию("МСЕдиницыВеличинОбозначения");
	
	Если Обозначения = Перечисления.МСЕдиницыВеличинОбозначения.Русские Тогда
		Возврат "Приставка";
	ИначеЕсли Обозначения = Перечисления.МСЕдиницыВеличинОбозначения.Международные Тогда
		Возврат "ПриставкаМеждународная";
	ИначеЕсли Обозначения = Перечисления.МСЕдиницыВеличинОбозначения.РусскиеISO_80000_1 Тогда
		Возврат "ПриставкаISO_80000_1";
	ИначеЕсли Обозначения = Перечисления.МСЕдиницыВеличинОбозначения.МеждународныеISO_80000_1 Тогда
		Возврат "ПриставкаМеждународнаяISO_80000_1";
	Иначе
		Возврат "Приставка";
	КонецЕсли;
...
// Возвращает наименование реквизита, содержащего обозначение приставки в зависимости от функциональных опций.
//
// Возвращаемое значение:
//   Строка - наименование реквизита
//
Функция ПолучитьРеквизитОбозначения() Экспорт
	...
	Если Обозначения = Перечисления.МСЕдиницыВеличинОбозначения.Русские Тогда
		Возврат "Обозначение";
	ИначеЕсли Обозначения = Перечисления.МСЕдиницыВеличинОбозначения.Международные Тогда
		Возврат "ОбозначениеМеждународное";
	ИначеЕсли Обозначения = Перечисления.МСЕдиницыВеличинОбозначения.РусскиеISO_80000_1 Тогда
		Возврат "ОбозначениеISO_80000_1";
	ИначеЕсли Обозначения = Перечисления.МСЕдиницыВеличинОбозначения.МеждународныеISO_80000_1 Тогда
		Возврат "ОбозначениеМеждународноеISO_80000_1";
	Иначе
		Возврат "Обозначение";
	КонецЕсли;
