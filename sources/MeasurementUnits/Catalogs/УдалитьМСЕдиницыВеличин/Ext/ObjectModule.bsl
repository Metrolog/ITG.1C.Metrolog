...
Процедура ПередЗаписью(Отказ)
	Если ОбменДанными.Загрузка Тогда
		Возврат;
	КонецЕсли;
	Обозначение = МСЕдиницыВеличинСервер.СформироватьОбозначениеЕдиницыВеличины(ЭтотОбъект);
	Наименование = МСЕдиницыВеличинСервер.СформироватьНаименованиеЕдиницыВеличины(ЭтотОбъект);
	Код = СформироватьХеш();
КонецПроцедуры
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Дубли = ПоискИУдалениеДублей.НайтиДублиЭлемента("Справочник.УдалитьМСЕдиницыВеличин", ЭтотОбъект, ДополнительныеПараметры);
...
Функция СформироватьХеш()
	...
	Для каждого Множитель Из ВыражениеТЗ Цикл
		ХэшОбозначения = ХэшОбозначения
			+ МСЕдиницыВеличинСервер.ПолучитьОбозначениеПриставки(Множитель.Приставка)
