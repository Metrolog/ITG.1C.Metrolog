...
Процедура НастройкаИнтерфейса(НастройкиРаботыИнтерфейса) Экспорт
	...
	МССтандартныеПодсистемы.НастройкаИнтерфейса(НастройкиРаботыИнтерфейса);
	// _Демо конец примера
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных);
	// _Демо конец примера
...
Процедура ПередПроверкойЗапретаИзменения(Объект,
	...
	// _Демо начало примера
	МССтандартныеПодсистемы.ПередПроверкойЗапретаИзменения(
