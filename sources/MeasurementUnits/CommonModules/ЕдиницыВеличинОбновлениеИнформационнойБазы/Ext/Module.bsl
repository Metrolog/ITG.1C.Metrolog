...
// ОбщийМодуль.ЕдиницыВеличинОбновлениеИнформационнойБазы.
//
////////////////////////////////////////////////////////////////////////////////
...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Версия = ЕдиницыВеличинКлиентСервер.ВерсияБиблиотеки();
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Модуль = Метаданные.ОбщиеМодули.ЕдиницыВеличинОбновлениеИнформационнойБазы;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = Модуль.Имя() + ".НачальноеЗаполнение";
	...
	Обработчик.Процедура = Модуль.Имя() + ".ЗаполнитьПриставкиЕдиницВеличин";
	Обработчик.ОбщиеДанные 		   = Истина;
	Обработчик.РежимВыполнения     = "Монопольно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "1.0.2.25";
	Обработчик.Процедура = Модуль.Имя() + ".ЗаполнитьКонстантуОбозначенияЕдиницВеличин";
	Обработчик.РежимВыполнения     = "Монопольно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "1.0.2.22";
	Обработчик.Процедура = Модуль.Имя() + ".ЗаполнитьКонстантуОбозначенияПриставокЕдиницВеличин";
	Обработчик.РежимВыполнения     = "Монопольно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "1.0.2.20";
	Обработчик.Процедура = Модуль.Имя() + ".ПерейтиНаВерсию_1_0_2_20";
	Обработчик.РежимВыполнения     = "Монопольно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "1.0.2.23";
	Обработчик.Процедура = Модуль.Имя() + ".ПерейтиНаВерсию_1_0_2_23";
	Обработчик.РежимВыполнения     = "Монопольно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "1.0.2.24";
	Обработчик.Процедура = Модуль.Имя() + ".ЗаполнитьВариантыОбозначенийЕдиницВеличин";
	Обработчик.ОбщиеДанные 		   = Истина;
	Обработчик.РежимВыполнения     = "Монопольно";
...
Процедура НачальноеЗаполнение() Экспорт
	...
	ЗаполнитьКонстантуОбозначенияПриставокЕдиницВеличин();
	ЗаполнитьКонстантуОбозначенияЕдиницВеличин();
...
Процедура ЗаполнитьПриставкиЕдиницВеличин() Экспорт
	...
	Перем Приставки;
	Приставки = Справочники.ПриставкиЕдиницыВеличин;
...
Процедура ЗаполнитьКонстантуОбозначенияПриставокЕдиницВеличин() Экспорт
	
	Константы.ОбозначенияПриставокЕдиницВеличин.Установить(Перечисления.ОбозначенияПриставокЕдиницВеличин.ПоПостановлениюПравительстваРФ879);
	
КонецПроцедуры

Процедура ЗаполнитьКонстантуОбозначенияЕдиницВеличин() Экспорт
	
	Константы.ОбозначенияЕдиницВеличин.Установить(
...
Процедура ПерейтиНаВерсию_1_0_2_20() Экспорт
	...
	Перем Приставки;
	Приставки = Справочники.ПриставкиЕдиницыВеличин.Выбрать();
...
Процедура ПерейтиНаВерсию_1_0_2_23() Экспорт
	...
	Константы.ОбозначенияЕдиницВеличин.Установить(Константы.ОбозначенияЕдиницВеличин.Получить());
	Константы.МСЕдиницыВеличинИспользоватьОбозначенияМн.Установить(Истина);
