...
Функция ПолучитьОбозначениеПриставки(Знач Приставка) Экспорт
	Если ЗначениеЗаполнено(Приставка) Тогда
		Возврат Приставка[МСЕдиницыВеличинКлиентСерверПовтИсп.ПолучитьРеквизитОбозначения()];
	Иначе
		Возврат "";
	КонецЕсли;
КонецФункции
...
Функция ПолучитьОбозначениеЕдиницыВеличиныБазовой(Знач Единица) Экспорт
	Возврат Единица[МСЕдиницыВеличинКлиентСерверПовтИсп.ПолучитьРеквизитОбозначения()];
КонецФункции
		...
		Для каждого Множитель Из Единица.Выражение Цикл
			Если Строка(Множитель.ПоказательСтепени) <> "0" Тогда 
				ПредставлениеМножителя =
					ПолучитьОбозначениеПриставки(Множитель.Приставка)
					+ МСЕдиницыВеличинСервер.ПолучитьОбозначениеЕдиницыВеличиныБазовой(Множитель.БазоваяЕдиница)
...
Функция ПолучитьПриставку(Знач Приставка) Экспорт
	Если ЗначениеЗаполнено(Приставка) Тогда
		Возврат Приставка[МСЕдиницыВеличинКлиентСерверПовтИсп.ПолучитьРеквизитНаименования()];
	Иначе
		Возврат "";
	КонецЕсли;
КонецФункции
...
Функция ПолучитьНаименованиеЕдиницыВеличиныБазовой(Знач Единица) Экспорт
	Возврат Единица[МСЕдиницыВеличинКлиентСерверПовтИсп.ПолучитьРеквизитНаименования()];
КонецФункции
...
Функция СформироватьНаименованиеЕдиницыВеличины(Знач Единица) Экспорт
	...
	Если Единица <> Справочники.МСЕдиницыВеличин.ПустаяСсылка() Тогда 
		...
		Для Каждого Множитель Из Единица.Выражение Цикл
			...
			ПредставлениеМножителя =
				МСЕдиницыВеличинСервер.ПолучитьПриставку(Множитель.Приставка)
				+ СклонениеПредставленийОбъектов.ПросклонятьПредставление(
					МСЕдиницыВеличинСервер.ПолучитьНаименованиеЕдиницыВеличиныБазовой(Множитель.БазоваяЕдиница)
