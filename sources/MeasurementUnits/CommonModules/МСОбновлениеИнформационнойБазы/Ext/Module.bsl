...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Модуль = Метаданные.ОбщиеМодули.МСОбновлениеИнформационнойБазы;
	...
	Обработчик.Процедура = Модуль.Имя + ".ВыполнятьВсегдаПриСменеВерсии";
	...
	Обработчик.Процедура = Модуль.Имя + ".ПервыйЗапуск";
	...
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура = Модуль.Имя + ".ВыполнитьПервоначальноеЗаполнениеВалют";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "0.1.0.25";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьПредопределенныеВидыКонтактнойИнформацииОрганизаций";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "0.1.0.25";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура = Модуль.Имя + ".ЗаполнитьКонстантуИспользоватьНесколькоОрганизаций";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "0.1.0.25";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьПредопределенныеВидыКонтактнойИнформации";
	...
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.ОбщиеДанные = Истина;
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьПредопределенныеКлючевыеОперации";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "0.1.0.25";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура = Модуль.Имя + ".ИнициализироватьРолиИсполнителей";
	
	Если Не ОбщегоНазначенияПовтИсп.РазделениеВключено() И Не ОбменДаннымиПовтИсп.ЭтоАвтономноеРабочееМесто() Тогда
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "*";
		Обработчик.Процедура = Модуль.Имя + ".ЗагрузитьДополнительныеОтчетыИОбработкиИзОбщихМакетов";
	...
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьДополнительныеОбработки_2_0_1_5";
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".ЗаполнитьКонстантыДляОрганизаций";
	Обработчик.РежимВыполнения = "Оперативно";
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".ЗаполнитьРеквизитГруппаДоступаУСправочниковГруппЗначенийДоступа";
	Обработчик.РежимВыполнения = "Оперативно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьПредопределенныеВидыКонтактнойИнформацииФизическихЛиц";
	Обработчик.ВыполнятьВГруппеОбязательных = Истина;
	Обработчик.Приоритет = 99;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьПредопределенныеВидыКонтактнойИнформацииКонтрагентов";
	Обработчик.ВыполнятьВГруппеОбязательных = Истина;
	Обработчик.Приоритет = 99;
	Обработчик.НачальноеЗаполнение = Истина;
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьПредопределенныйВидКонтактнойИнформации";
	Обработчик.ВыполнятьВГруппеОбязательных = Истина;
	Обработчик.Приоритет = 99;
	Обработчик.НачальноеЗаполнение = Истина;
	...
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Версия    = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".СброситьНастройкиОтчетов";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьИспользованиеКонтактнойИнформацииКонтактныхЛицПартнеров";
	Обработчик.РежимВыполнения = "Оперативно";
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьИспользованиеНаборовСвойствВнешнихПользователей";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.НачальноеЗаполнение = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьПорядокВидовКонтактнойИнформацииКонтрагентов";
	Обработчик.РежимВыполнения = "Оперативно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".УстановитьНазначенияРолейИсполнителей";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.НачальноеЗаполнение = Истина;
	...
	Обработчик.Процедура = Модуль.Имя + ".ЗаполнитьКонтактнуюИнформациюДляСписков";
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".ВключитьОграничениеПоПартнерамПриИспользованииВнешнихПользователей";
	Обработчик.РежимВыполнения = "Оперативно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия    = "0.1.0.25";
	Обработчик.Процедура = Модуль.Имя + ".НастроитьИсториюКонтактнойИнформацииИМногострочноеПоле";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.НачальноеЗаполнение = Истина;
	...
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьНаборыЗначенийДоступаЗаданийСРолевойАдресацией";
	...
	Обработчик.Процедура = Модуль.Имя + ".ОбновитьКонтактнуюИнформациюЗаказовПокупателя";
	...
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.ПроцедураПроверки = Модуль.Имя + ".ЗаполненыДанныеДляСпискаЗаказПокупателя";
	Обработчик.БлокируемыеОбъекты = "Документ._ДемоЗаказПокупателя, Отчет._ДемоСтатусыЗаказовПокупателей";
	...
	Обработчик.ПроцедураПроверки    = Модуль.Имя + ".ОбработкаДанныхЗавершена";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "0.1.0.25";
	Обработчик.Процедура           = Модуль.Имя + ".ЗаполнитьШаблоныСообщений";
	Обработчик.РежимВыполнения     = "Оперативно";
	Обработчик.НачальноеЗаполнение = Истина;
