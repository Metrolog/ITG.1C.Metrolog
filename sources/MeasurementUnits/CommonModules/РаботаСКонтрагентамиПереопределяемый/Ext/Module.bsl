...
Процедура ДополнитьРеквизитыФормыКонтрагент(Форма, НовыеРеквизиты) Экспорт
	...
	Если Форма.ИмяФормы = "Справочник._ДемоКонтрагенты.Форма.ФормаЭлемента" Тогда
		...
		НовыеРеквизиты.ЭтоЮридическоеЛицо  		 = Форма.Объект.ВидКонтрагента = Перечисления._ДемоВидКонтрагента.ЮридическоеЛицо;
...
#Область ЗаполнениеРеквизитовКонтрагента
	...
	Если Реквизиты.ВидКонтрагента = Перечисления._ДемоВидКонтрагента.ЮридическоеЛицо Тогда
...
Процедура ДополнитьДанныеКонтрагентов(ДанныеКонтрагентов, СтандартнаяОбработка) Экспорт
	...
	Если ОбщегоНазначенияПовтИсп.РазделениеВключено()
		...
		Запрос.Текст = 
			...
			|			ТОГДА ВЫБОР
			|					КОГДА _ДемоКонтрагенты.ВидКонтрагента ЕСТЬ NULL 
			|						ТОГДА ВЫБОР
			...
			|							КОНЕЦ
			|					ИНАЧЕ ВЫБОР
			|							КОГДА _ДемоКонтрагенты.ВидКонтрагента = ЗНАЧЕНИЕ(Перечисление._ДемоВидКонтрагента.ЮридическоеЛицо)
			|								ТОГДА ИСТИНА
			|							ИНАЧЕ ЛОЖЬ
			|						КОНЕЦ
			|				КОНЕЦ
