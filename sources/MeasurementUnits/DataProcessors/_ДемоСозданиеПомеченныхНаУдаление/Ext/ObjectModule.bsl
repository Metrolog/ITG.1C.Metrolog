...
Процедура СоздатьПомеченныеДляПрочихСценариев(Настройки, Результат)
	...
	Если Не ЗначениеЗаполнено(КонтрагентСсылка) Тогда
		...
		КонтрагентОбъект.ВидКонтрагента = Перечисления._ДемоВидКонтрагента.ЮридическоеЛицо;
	...
	КонецЕсли;
	ВидРасчета2Объект.БазовыеВидыРасчета.Очистить();
	
	СтрокаТаблицы = ВидРасчета2Объект.БазовыеВидыРасчета.Добавить();
