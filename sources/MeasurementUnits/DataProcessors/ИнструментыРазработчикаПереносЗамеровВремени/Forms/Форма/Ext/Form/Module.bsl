...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Объект.ДатаНачалаОбнаружено = ?(ДатаНачала < ДатаНачалаТехнологические, ДатаНачала, ДатаНачалаТехнологические);
	Объект.ДатаНачалаПеренос = Объект.ДатаНачалаОбнаружено;
	
	Объект.ДатаОкончанияОбнаружено = ?(ДатаОкончания > ДатаОкончанияТехнологические, ДатаОкончания, ДатаОкончанияТехнологические);
...
Функция ПеренестиЗаписи(Результат)
	...
	НаборЗаписейУдалить = РегистрыСведений.УдалитьЗамерыВремени2.СоздатьНаборЗаписей();
